...
class Player():
    ...
    def move(self):
        ...
        for platform in platform_image:
            ...
            #check if the player has bounced to the top of teh screen
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y, bird_sheet, speed):
        super().__init__()
...
class Platform(pygame.sprite.Sprite):
     ...
     def update(self, scroll):
        #moving platforms side to side if it is a moving platform
        if self.moving == True:
            self.move_counter += 1
            self.rect.x += self.direction * self.speed
            
        #change platform direction if it has moved fully or bit a wall
        ...
        #check if platform has game off the screen
